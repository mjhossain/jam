...
// try creating a function for this
								...
								// This below code is to set marker image

								// var marker_img;

								// if (type == 'open') {
								// 	marker_img = markerImage;
								// } else if (type == 'parked') {
								// 	marker_img = 'marker2.png';
								// }
								...
								function createMarker(latlng, name, type){
										...
										//above code is for marker image
